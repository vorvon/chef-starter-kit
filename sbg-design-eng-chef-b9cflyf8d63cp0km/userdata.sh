...
CHEF_SERVER_NAME="sbg-design-eng-chef" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="sbg-design-eng-chef-b9cflyf8d63cp0km.us-west-2.opsworks-cm.io" # The FQDN of your Chef Server
